...
import 'package:money_mate/presentation/pages/onboarding/onboarding_page.dart';
...
void main() {
  ...
  testWidgets('Chuyển trang khi nhấn nút NEXT', (WidgetTester tester) async {
    ...
    expect(find.text('Get your notifications or alert\nwhen you do the over expenses'), findsOneWidget);
  });

  testWidgets('Hiển thị nút LET\'S GO ở trang cuối cùng', (WidgetTester tester) async {
    await tester.pumpWidget(createTestableWidget());
    ...
    expect(find.text('Tracking your expense help make sure\nyou don\'t overspend'), findsOneWidget);
  });
