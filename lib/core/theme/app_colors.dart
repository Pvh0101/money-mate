...
const Color primaryBrandBlue = Color(
    0xFF0E33F3); // From rectangle fill, named "Primary/Orange" in Figma layer but is blue
const Color primaryBrandOrange =
    Color(0xFFF95D3B); // From text layer, associated with "Primary/Orange"

// Figma specific for Total Expense Screen
const Color primaryBlueGradientStartFigma = Color(0xFF2F51FF);
...
const Color secondaryRedLight =
    Color(0xFFFFD7D7); // Rectangle fill, text was AB091E
const Color secondarySoftOrange = Color(0xFFFDE1CE);
const Color secondaryDarkBrandOrange = Color(
    0xFF395EEC); // Rectangle fill, text was E85737, named "Secondary/Dark Brand"
const Color secondaryRedDark =
    Color(0xFFC62B30); // Rectangle fill, text was AB091E
...
const Color appPrimaryIndigo =
    Color(0xFF4F46E5); // This was the initial primary for M3 seed
const Color appPrimaryBlue =
    Color(0xFF2563EB); // This was the initial secondary for M3 seed
