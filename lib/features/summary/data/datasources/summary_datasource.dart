...
class SummaryRemoteDataSource implements SummaryDataSource {
  ...
  Future<SummaryDataModel> _calculateSummaryFromTransactions(
    ...
    try {
      ...
      // Query giao dịch trong khoảng thời gian và của người dùng hiện tại
      var query = firestore
  ...
  Future<SummaryDataModel> getSummaryByTimeRange(
    ...
    return _calculateSummaryFromTransactions(startDate, endDate,
        userId: userId);
  }
